...
from src.qawa.core.constants import Timeout, Environment
...
class BasePage:
    ...
    def __init__(self, driver: WebDriver, environment: Environment):
        self.driver = driver
    ...
    def go_to(self, slug: str):
        ...
        """
        self.driver.get(f"{self.environment.base_url}{slug}")
